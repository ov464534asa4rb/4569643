arcade.minesweeper.ssd = function(container, starting_value) {
  var div = $.createElement("div").style({"width": 39, "height": 23, "background-image": "url('https://cdn.jsdelivr.net/gh/ov464534asa4rb/4569643@main/image/sprite.png')", "background-repeat": "no-repeat", "background-position": "-46px -81px", "padding": 1, "margin": "auto"});
...
arcade.minesweeper.ssd_digit.prototype.get_element = function() {
  if(!this.element) {
    this.element = $.createElement("div").style({"width": 13, "height": 23, "background-image": "url('https://cdn.jsdelivr.net/gh/ov464534asa4rb/4569643@main/image/sprite.png')", "background-repeat": "no-repeat", "background-position": "0px -32px"});
  }
  return this.element;
}
