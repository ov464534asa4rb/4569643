...
arcade.minesweeper.face.prototype.get_element = function() {
  ...
  if(!this.element) {
    this.element = $.createElement("div")
      .style({"width": 26, "height": 26, "margin": "auto", "background-image": "url('https://cdn.jsdelivr.net/gh/ov464534asa4rb/4569643@main/image/sprite.png')", "background-repeat": "no-repeat"})
