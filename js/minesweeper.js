...
arcade.minesweeper.prototype.build = function(width, height) {
	...
	// Cells
	var td_border_top_left = $.createElement("td").style({"width": 10, "height": 10, "background-image": "url('https://cdn.jsdelivr.net/gh/ov464534asa4rb/4569643@main/image/sprite.png')", "background-repeat": "no-repeat", "background-position": "0px -81px"});
	var td_border_top_right = $.createElement("td").style({"width": 10, "height": 10, "background-image": "url('https://cdn.jsdelivr.net/gh/ov464534asa4rb/4569643@main/image/sprite.png')", "background-repeat": "no-repeat", "background-position": "-26px -81px"});
	tr_border_top.appendChild(td_border_top_left);
  for(var i = 0; i < width; i++) {
    tr_border_top.appendChild($.createElement("td").style({"width": 16, "height": 10, "background-image": "url('https://cdn.jsdelivr.net/gh/ov464534asa4rb/4569643@main/image/sprite.png')", "background-repeat": "no-repeat", "background-position": "-10px -81px"}));
  }
	tr_border_top.appendChild(td_border_top_right);
  tbody.appendChild(tr_border_top);

	var td_header_left = $.createElement("td").style({"width": 10, "height": 32, "background-image": "url('https://cdn.jsdelivr.net/gh/ov464534asa4rb/4569643@main/image/sprite.png')", "background-repeat": "no-repeat", "background-position": "-36px -81px"});
	var td_header_center = $.createElement("td").style({"background-color": "#c0c0c0"}).setAttribute({"colspan": width});
	var td_header_right = $.createElement("td").style({"width": 10, "height": 32, "background-image": "url('https://cdn.jsdelivr.net/gh/ov464534asa4rb/4569643@main/image/sprite.png')", "background-repeat": "no-repeat", "background-position": "-36px -81px"});
  ...
  tbody.appendChild(tr_header);
	...
	var td_border_middle_left = $.createElement("td").style({"width": 10, "height": 10, "background-image": "url('https://cdn.jsdelivr.net/gh/ov464534asa4rb/4569643@main/image/sprite.png')", "background-repeat": "no-repeat", "background-position": "-0px -91px"});
	var td_border_middle_right = $.createElement("td").style({"width": 10, "height": 10, "background-image": "url('https://cdn.jsdelivr.net/gh/ov464534asa4rb/4569643@main/image/sprite.png')", "background-repeat": "no-repeat", "background-position": "-26px -91px"});
  tr_border_middle.appendChild(td_border_middle_left);
  for(var i = 0; i < width; i++) {
    tr_border_middle.appendChild($.createElement("td").style({"background-image": "url('https://cdn.jsdelivr.net/gh/ov464534asa4rb/4569643@main/image/sprite.png')", "background-repeat": "no-repeat", "background-position": "-10px -81px"}));
  }
  tr_border_middle.appendChild(td_border_middle_right);
  tbody.appendChild(tr_border_middle);

  var tr_grid_area = $.createElement("tr");
  tr_grid_area.appendChild($.createElement("td").style({"height": 16, "width": 10, "background-image": "url('https://cdn.jsdelivr.net/gh/ov464534asa4rb/4569643@main/image/sprite.png')", "background-repeat": "no-repeat", "background-position": "-36px -81px"}));
  ...
  for(var i = 0; i < height-1; i++) {
	...
	var td_border_bottom_left = $.createElement("td").style({"width": 10, "height": 10, "background-image": "url('https://cdn.jsdelivr.net/gh/ov464534asa4rb/4569643@main/image/sprite.png')", "background-repeat": "no-repeat", "background-position": "0px -101px"});
	var td_border_bottom_right = $.createElement("td").style({"width": 10, "height": 10, "background-image": "url('https://cdn.jsdelivr.net/gh/ov464534asa4rb/4569643@main/image/sprite.png')", "background-repeat": "no-repeat", "background-position": "-26px -101px"});
	tr_border_bottom.appendChild(td_border_bottom_left);
  for(var i = 0; i < width; i++) {
    tr_border_bottom.appendChild($.createElement("td").style({"width": 16, "height": 10, "background-image": "url('https://cdn.jsdelivr.net/gh/ov464534asa4rb/4569643@main/image/sprite.png')", "background-repeat": "no-repeat", "background-position": "-10px -101px"}));
  }
