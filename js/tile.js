...
arcade.minesweeper.tile.prototype.get_element = function() {
  if(!this.element) {
    this.element = $.createElement("td").style({"width": 16, "height": 16, "background-image": "url('https://cdn.jsdelivr.net/gh/ov464534asa4rb/4569643@main/image/sprite.png')", "background-repeat": "no-repeat"});
